...
const MainLayout = ({
  ...
  const getBreadcrumbs = () => {
    ...
    switch (currentView) {
      case "dashboard":
        return ["Test Creation", "View Tests"];
      case "test-creation":
        return ["Test Creation", "Create Test", "Chapter Wise"];
      case "test-publish":
        return ["Test Creation", "Preview & Publish"];
      case "test-tracking":
  ...
  return (
    <div className="flex h-screen w-screen flex-col overflow-hidden bg-white">
      ...
      {notification && (
        <div
          className={`fixed top-4 right-4 z-[9999] flex items-center gap-3 px-4 py-3 rounded-xl border shadow-lg animate-in slide-in-from-top-2 fade-in duration-200 ${
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="flex-1 flex flex-col overflow-hidden bg-white">
          ...
          <div
            className={`flex items-center justify-between px-6 py-4 border-b border-[#f4f6fc] bg-white shrink-0 select-none ${
              currentView === "test-editor" ? "lg:pl-[244px]" : ""
            }`}
          >
