  ...
  return (
    <div className="space-y-1 relative">
      ...
      <div
        ...
        className={`w-full min-h-[38px] text-xs text-gray-500 bg-white px-3 py-2 rounded-lg border border-gray-200 flex items-center justify-between cursor-pointer disabled:bg-gray-50 select-none ${
            ...
            {options.length === 0 ? (
              ...
              options.map((opt) => (
                <div
                  ...
                  className={`px-2.5 py-1.5 hover:bg-gray-50 rounded-md cursor-pointer transition-colors text-xs text-gray-700 font-medium select-none ${
...
const TestEditor = ({
  ...
  return (
    ...
    >
                    ...
                    {currentQuestion.options.map((option, optIdx) => (
                      <div key={optIdx} className="flex items-center gap-3">
                        <button
                          ...
                          className={`h-5.5 w-5.5 rounded-full border flex items-center justify-center shrink-0 cursor-pointer ${
      ...
      {isSuccessModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-600/40 backdrop-blur-xs p-4">
